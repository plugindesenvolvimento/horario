...
@Entity
@Table(name = "disciplinaprofessor", schema = "academico")
public class DisciplinaProfessor {
	...
	@Id
	@SequenceGenerator(name="SEQ_DISCIPLINA_PROFESSOR", schema = "academico", sequenceName="SEQ_DISCIPLINA_PROFESSOR_ID", allocationSize=1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator="SEQ_DISCIPLINA_PROFESSOR")
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DisciplinaProfessor other = (DisciplinaProfessor) obj;
		if (id == null) {
			if (other.id != null)
				return false;
